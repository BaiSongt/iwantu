...
export default function ProductsError({
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-10">
      <div className="flex flex-col items-center justify-center rounded-2xl border border-red-100 bg-white px-6 py-16 text-center shadow-[0_8px_40px_rgba(15,23,42,0.06)]">
